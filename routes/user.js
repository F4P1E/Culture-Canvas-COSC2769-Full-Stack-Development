...
//controller function
const { loginUser, signupUser, sendFriendRequest, cancelFriendRequest, acceptRequest, unFriend, getPosts, getPostsFromSpecificUser, getEditHistory, getCommentsFromPost, getCommentEditHistory } = require('../controllers/userController');
